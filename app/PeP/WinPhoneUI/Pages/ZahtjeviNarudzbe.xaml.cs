...
namespace WinPhoneUI.Pages {
    ...
    /// </summary>
    public sealed partial class ZahtjeviNarudzbe : Page {
        public ZahtjeviNarudzbe() {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e) {
            ...
            HttpResponseMessage response1 = serviceNarudzbe.GetResponseParams("GetBrojZahtjevaDolaznih", Global.logiraniKorisnik.Id.ToString());
            if (response1.IsSuccessStatusCode)
                BrojDolaznih.Text += response1.Content.ReadAsAsync<int>().Result.ToString();

            HttpResponseMessage response2 = serviceNarudzbe.GetResponseParams("GetBrojZahtjevaOdlaznih", Global.logiraniKorisnik.Id.ToString());
            if (response1.IsSuccessStatusCode)
    ...
    private void tbDolazni_Tapped(object sender, TappedRoutedEventArgs e) {
            Frame.Navigate(typeof(DolazniZahtjevi));
        }
        ...
        private void imgOdlazni_Tapped(object sender, TappedRoutedEventArgs e) {
            Frame.Navigate(typeof(OdlazniZahtjevi));
        }
