...
namespace WinPhoneUI.Pages {
    ...
    /// </summary>
    public sealed partial class DolazniZahtjevi : Page {
        public DolazniZahtjevi() {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e) {
            ...
            HttpResponseMessage response = serviceNarudzbe.GetResponseParams("GetDolazniZahtjevi", Global.logiraniKorisnik.Id.ToString());
            if (response.IsSuccessStatusCode) {
                lvDolazniZahtjevi.ItemsSource = response.Content.ReadAsAsync<List<NarudzbaVM>>().Result;
            }

            HttpResponseMessage responseNotifikacija = serviceNotifikacije.GetResponseParams("GetNotifikacijeDolazniZahtjevi", Global.logiraniKorisnik.Id.ToString());
        ...
        private void lvDolazniZahtjevi_ItemClick(object sender, ItemClickEventArgs e) {
            Frame.Navigate(typeof(ProcesirajZahtjev) ,((NarudzbaVM)e.ClickedItem).NarudzbaId);
        }
