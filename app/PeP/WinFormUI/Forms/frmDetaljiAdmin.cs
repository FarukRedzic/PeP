...
namespace WinFormUI.Forms {
    public partial class frmDetaljiAdmin : Form {
        ...
        private int AdminId;
        public frmDetaljiAdmin(int AdminId) {
            this.AdminId = AdminId;
            InitializeComponent();
        }

        private void frmDetaljiAdmin_Load(object sender, EventArgs e) {
            HttpResponseMessage response = serviceKorisnik.GetResponseParams("GetDetaljiAdmin", new string[] { AdminId.ToString() });
            ...
            HttpResponseMessage pouzdanostResponse = serviceDojmovi.GetResponseParams("GetPouzdanost", new string[] { AdminId.ToString() });
        ...
        private void btnObrisiProfil_Click(object sender, EventArgs e) {
            ...
            if (response.IsSuccessStatusCode) {
                ...
                if (k.Aktivan == 0) {
                    ...
                    k.Aktivan = 0;
                    HttpResponseMessage response2 = serviceKorisnik.PutResponse(AdminId, k);
                    if (response.IsSuccessStatusCode) {
        ...
        private void btnTraziProizvode_Click(object sender, EventArgs e) {
            ...
            HttpResponseMessage responseProizvod = serviceProizvodi.GetResponseParams("GetProizvodiByParameters", new string[] { AdminId.ToString(), NazivProizvoda.Trim(), Convert.ToInt32(cbxKategorijaProizvoda.SelectedValue).ToString(), CijenaOD.Trim(), CijenaDO.Trim() });
        ...
        private void btnTraziNarudzbe_Click(object sender, EventArgs e) {
            ...
            if (txtBrojNarudzbe.Text == "")
                ...
                HttpResponseMessage responseNarudzba = serviceNarudzbe.GetResponseParams("GetNarudzbeByParams", new string[] { AdminId.ToString(),
                BrojNarudzbe.Trim(),
        ...
        private void btnTraziFavorite_Click(object sender, EventArgs e) {
            ...
            HttpResponseMessage responseFavoriti = serviceFavoriti.GetResponseParams("GetFavoritiByParams", new string[] { AdminId.ToString(), NazivProizvoda_Favoriti.Trim(), Convert.ToInt32(cbxKategorijaProizvoda_Favoriti.SelectedValue).ToString(), CijenaOD_Favoriti.Trim(), CijenaDO_Favoriti.Trim() });
        ...
        private void btnTraziDojam_Click(object sender, EventArgs e) {
            ...
            HttpResponseMessage responseDojam = serviceDojmovi.GetResponseParams("GetDojmoviByParams", new string[] { AdminId.ToString(), Ime_Dojam.Trim(), Prezime_Dojam.Trim(), OcjenaOD.ToString(), OcjenaDO.ToString()});
        ...
        private void btnAktivirajProfil_Click(object sender, EventArgs e) {
            ...
            if (response.IsSuccessStatusCode) {
                Korisnik k = response.Content.ReadAsAsync<Korisnik>().Result;
                if (k.Aktivan == 1) {
                    MessageBox.Show("Administrator je trenutno aktivan!", Global.GetMessage("warning"), MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else {
                    k.Aktivan = 1;
                    HttpResponseMessage response2 = serviceKorisnik.PutResponse(AdminId, k);
                    if (response.IsSuccessStatusCode) {
                        MessageBox.Show("Administrator je uspješno aktiviran!", Global.GetMessage("Information"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                        this.Close();
                    }
                }
            }
        ...
        private void btnDeaktivirajProfil_Click(object sender, EventArgs e) {
            ...
            if (dialogResult == DialogResult.Yes) {
                ...
                if (response.IsSuccessStatusCode) {
                    Korisnik k = response.Content.ReadAsAsync<Korisnik>().Result;
                    if (k.Aktivan == 0) {
                        MessageBox.Show("Administrator je trenutno neaktivan!", Global.GetMessage("warning"), MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                    else {
                        k.Aktivan = 0;
                        HttpResponseMessage response2 = serviceKorisnik.PutResponse(AdminId, k);
                        if (response.IsSuccessStatusCode) {
                            MessageBox.Show("Administrator je uspješno deaktiviran!", Global.GetMessage("Information"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                            this.Close();
                        }
                    }
                }
        ...
        private void btnTraziProdao_Click(object sender, EventArgs e) {
            ...
            HttpResponseMessage responseNarudzba = serviceNarudzbe.GetResponseParams("GetProdaneByParams", new string[] { AdminId.ToString(),
                BrojNarudzbe.Trim(),
        ...
        private void ClearInputProdao() {
            ...
            dtpODProdoa.Value = dtpODProdoa.MinDate;
            dtpDOProdao.Value = dtpDOProdao.MaxDate;
        }
        ...
        private void btnIspis_Click(object sender, EventArgs e) {
            ...
            Reports.Reports rpt = new Reports.Reports(listaProizvodi, "metroProizvodi");
            rpt.ShowDialog();
        }
        private void btnProdaoIspis_Click(object sender, EventArgs e) {
        ...
        private void btnFavoritiIspis_Click(object sender, EventArgs e) {
        ...
        private void btnNarudzbeIspis_Click(object sender, EventArgs e) {
